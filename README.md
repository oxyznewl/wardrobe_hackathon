...
app/
├── database.py      # DB 연결 설정 (기존 유지)
├── models.py        # [Domain] SQLAlchemy ORM 모델 (기존 유지)
├── schemas.py       # [Domain] Pydantic DTO (main.py에서 분리)
├── repositories.py  # [Repository] DB 쿼리 전담 (crud.py 대체)
